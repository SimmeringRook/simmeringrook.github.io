...
Time permitting, the codebase will be modular and well documented, allowing for integration into similar codebases, such as the Hadley Research Group Protostar Modeling project. The underlying latticework of grid points will be implemented without assumptions of the geometry of spacetime to allow straightforward modular use with more complicated spacetimes being introduced in the future such as the Reissner-Nordström or Kerr geometries.
